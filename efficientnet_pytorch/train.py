...
#from    model_triplet import EfficientNet
...
#SIRI-WHU12_0.5_0.25_0.25 /OPTIMAL31_0.8_0.1_0.1  /AID_0.2_0.4_0.4  /AID_0.5_0.25_0.25
#UCMerced_LandUse/UC21_0.5_0.25_0.25 /UCMerced_LandUse/UC21_0.8_0.1_0.1
#NWPU-RESISC45/NWPU45_0.2_0.4_0.4  /NWPU-RESISC45/NWPU45_0.1_0.45_0.45
parser = argparse.ArgumentParser(description='Remote sensing image classification')
#parser.add_argument('-D','--image_root', default = '/usr/LL/dataset/NWPU-RESISC45/NWPU45_0.2_0.4_0.4', type=str, help='the root path of train data')
...
#parser.add_argument('-D','--image_root', default = '/root/LL/dataset/AID_0.5_0.25_0.25', type=str, help='the root path of train data')
...
# parser.add_argument('--weight_root', default='/root/LL/efficientnet_pytorch/weights', type=str, help='the path of weights will save')
# parser.add_argument('--log_root', default='/root/LL/efficientnet_pytorch/log', type=str, help='the path of log will save')
...
parser.add_argument('--model_name', default='efficientnet-b0', type=str, help='the name of model')
...
#    model_name_self = model_name[0:15]
    model_name_self = 'efficientnet-b0'
    ...
    #criterion = LabelSmoothCELoss(smoothing=args.smoothing).to(device)
    ...
    log_root_name = os.path.join(log_root, urllib.parse.quote(log_name, safe='+/'))
    # print("log_name=",log_root_name)
...
#        att_outputs,
        per_outputs = model(images)
        loss = criterion(per_outputs, labels)
