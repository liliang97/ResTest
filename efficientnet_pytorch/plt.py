...
if __name__ == '__main__':
    ...
    path_img = 'D:/dataset/AID0.2/test/Airport/airport_2.jpg'
    path_net = './weights/AID_0.2_0.4_0.4_40_efficientnet-b0-att.pkl'
    output_dir = './visualize/cam'
    ...
    net.load_state_dict(torch.load(path_net, map_location=torch.device('cpu')), strict=False)
    ...
    # forward
    att_outputs, output = net(img_input)
